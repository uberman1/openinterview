...
cp('public/js/topmenu.unify.v4.bind.js','public/js/topmenu.unify.v4.bind.js');
...
function inject(route, fileName){
  const marker = `/* TOPMENU_UNIFY_V4_${route.replace(/[\/\.]/g,'_')} */`;
...
app.get('${route}', (req,res) => {
  try{
    ...
    if (!html.includes('/js/topmenu.unify.v4.bind.js')){
      html = html.replace('</body>', '<script src="/js/topmenu.unify.v4.bind.js" defer></script></body>');
    }
...
console.log('✔ Patched index.js with Top Menu v4 binder');