...
cp('public/js/topmenu.unify.v3.bind.js','public/js/topmenu.unify.v3.bind.js');
...
function injectBinder(route, fileName){
  const marker = `/* TOPMENU_UNIFY_V3_${route.replace(/[\/\.]/g,'_')} */`;
...
app.get('${route}', (req,res) => {
  try{
    ...
    if (!html.includes('/js/topmenu.unify.v3.bind.js')){
      html = html.replace('</body>', '<script src="/js/topmenu.unify.v3.bind.js" defer></script></body>');
    }
...
console.log('✔ Patched index.js with Top Menu v3 binder on target routes');