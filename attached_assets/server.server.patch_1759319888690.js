// /server/server.js — m04a: mount unified auth, ensure API before any static
...
// m04a: unified auth router (selects mock or real based on USE_MOCK_AUTH)
mountAuth(app, API_BASE);

// m04a: API routes mounted before any static
