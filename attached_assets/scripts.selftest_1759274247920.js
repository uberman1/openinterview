// /scripts/selftest.js — Module-aware, Node 20 compatible, Module 03 -> logs/mod-03b.log
import fs from 'fs'
import path from 'path'
import { spawn } from 'child_process'

const MOD = (process.env.MODULE_NUM || '00').toString().padStart(2, '0')
const PORT = '5050' // force 5050 to avoid 5000 conflicts
...
const logFileName = MOD === '03' ? 'mod-03b.log' : `selftest.mod-${MOD}.log`
