...
def main():
    ...
    update_test_index("Uploads", "v0.1.0", "Uploads page: size check, progress, cancel, visual", "/uploads_test.html",
                      f"/qa/uploads/v0.1.0/uploads.html.txt", f"/qa/uploads/v0.1.0/tests.txt")
