...
CREATE TABLE IF NOT EXISTS entitlements (
  ...
  -- Stores the plan code to apply at next renewal when a user downgrades mid-period
  pending_downgrade_plan VARCHAR(50) DEFAULT NULL,

  -- When user schedules cancel at period end (Stripe portal)
  stripe_cancel_at_period_end TIMESTAMP DEFAULT NULL,
