...
from profile_pack.tests_contract import run_contract, load_contract as load_contract_contract
from profile_pack.tests_behavior import run_workflows, load_contract as load_contract_behavior
from profile_pack.tests_a11y import run_a11y, load_contract as load_contract_a11y
from profile_pack.tests_security import run_security, load_contract as load_contract_security
from profile_pack.tests_visual import run_visual, load_contract as load_contract_visual
...
Timestamp: {rollup["timestamp"]}"""
    ...
    # Append row into test2.html under <section id="shareable-profile">
    description = "✅ Shareable Profile: copy link, toggle sections, a11y, CSP, visual (1 baseline)"
    ...
    print(f"Artifacts: {os.path.join(outdir,'tests.txt')} {os.path.join(outdir,'shareable_profile.html.txt')}")
