...
{json.dumps(rollup['suites'], indent=2)}"""
    ...
    updated = update_test_index(
        "uploads", 
        "v0.1.1", 
        "✅ Uploads: MIME validation, preseed profiles, avatar PASS, size/progress/cancel, visual (1 baseline)", 
        "/uploads_test.html",
        "/qa/uploads/v0.1.1/uploads.html.txt", 
        "/qa/uploads/v0.1.1/tests.txt"
    )
