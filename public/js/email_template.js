export function buildEmail({ senderName = "A colleague", message = "", link = "#" }) {
  ...
  const sanitizeUrl = (url) => {
    ...
    try {
      ...
      // Reject URLs with dangerous characters that could break out of attribute context
      const dangerousChars = /[<>"'`(){}]/;
      if (dangerousChars.test(parsed.href)) return '#';
      
      // Always escape, even though we've validated
      return esc(url);
    } catch {
      return '#';
    }
...
<title>OpenInterview Email</title>
<style>
...
<body>
  <div class="card">
    ...
    <div class="content">
      ...
      <p style="margin:18px 0 4px 0;"><a href="${safeLink}" class="btn" target="_blank" rel="noopener">View Interview</a></p>
    </div>
    <div class="footer">
