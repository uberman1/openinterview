...
(async function initDashboard() {
  ...
  try {
    ...
    if (data.shareLink?.url) {
      ...
      shareLinkSection.className = 'dashboard-share-link-card flex flex-col gap-4 rounded border border-green-500 bg-green-50 p-6 dark:bg-green-900/20';
      shareLinkSection.innerHTML = `
        <div class="relative z-10 flex items-center gap-2">
          <span class="dashboard-share-link-icon material-symbols-outlined text-green-600">link</span>
          <h3 class="text-lg font-bold text-green-800 dark:text-green-200">Your Share Link</h3>
        </div>
        <div class="relative z-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4">
        ...
        <p class="relative z-10 text-sm text-green-700 dark:text-green-300">
